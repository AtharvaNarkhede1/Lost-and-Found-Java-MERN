...
function MainView({ currentUser, onLogout, onOpenPostCreation }) {
  ...
  const loadPosts = async () => {
    try {
      ...
      if (showMine) {
        res = await axios.get(
          `https://lost-and-found-java-mern.onrender.com/api/posts?userId=${currentUser.userId}`
        );
      } else {
        res = await axios.get("https://lost-and-found-java-mern.onrender.com/api/posts?isApproved=true");
      }
  ...
  const submitClaim = async (reason, contact) => {
    try {
      await axios.post("https://lost-and-found-java-mern.onrender.com/api/claims", {
